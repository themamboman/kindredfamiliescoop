...
export default function ApplyPage() {
  const [children, setChildren] = useState([
    { name: '', dob: '', grade: '', allergies: '', needs: '', notes: '' },
  ])
  ...
  return (
    <main className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white p-10 rounded-xl shadow-md transition-all duration-300">
        <h1 className="text-4xl font-heading text-brand mb-2 text-center">
          Family Application Form
        </h1>
        <p className="text-center text-gray-600 mb-8">
          Please complete the form to apply for participation in the Kindred Families Homeschool
          Co-op.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-16">
          ...
          <section className="pt-4">
            <h2 className="text-2xl font-semibold text-brand border-b pb-2 mb-8">
              Family Information
            </h2>
          ...
          <section className="pt-4">
            ...
            {children.map((child, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-6 border rounded-md p-4 mb-6 transition duration-300">
                <label className="block">
            ...
            <button type="button" onClick={addChild} className="text-sm px-4 py-2 border border-brand text-brand rounded hover:bg-brand hover:text-white transition">
              + Add Another Child
            </button>
          </section>
          ...
          <section className="pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* All original labels restored here */}
              <label className="block">
          ...
          <div className="text-center">
            <button type="submit" className="bg-brand text-white px-10 py-3 rounded-md font-semibold hover:bg-red-800 transition">
              Submit Application
            </button>
          </div>
        </form>
